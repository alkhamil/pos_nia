...
<head>
    ...
    <link href="<?= base_url('assets/css/sb-admin-2.min.css?n=3') ?>" rel="stylesheet">
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?php if($uri=='tahun_ajaran') echo 'active' ?>">
        <a class="nav-link" href="<?= base_url('tahun_ajaran') ?>">
            <i class="fas fa-fw fa-cog"></i>
            <span>Tahun Ajaran</span>
        </a>
    </li>
    <li class="nav-item <?php if($uri=='lembaga') echo 'active' ?>">
