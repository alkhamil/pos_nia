                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="kelas_id" id="kelas_id" class="form-control form-required" style="width: 100%" data-placeholder="Pilih Tahun" required disabled>
                                        </select>
...
<script>
    ...
    $("#kelas_id").select2({
        ajax: {
            ...
            delay: 100,
            data: function(params) {
                let tingkat = (lembaga_name == 'SMP' || lembaga_name == 'MTS') ? 1 : 2;
                var query = {
                    q: params.term,
                    type: 'public',
                    tingkat: tingkat
