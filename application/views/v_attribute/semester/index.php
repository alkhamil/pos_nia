        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <form action="<?= $simpan ?>" method="POST" id="form-attribute-semester">
                            <div class="row">
...
<script>
    showLoad();
    let opt_attribute_type = new Option('SEMESTER', '2', true, true);
    ...
    $(document).on("click.ev", ".btn-edit", function(e) {
        ...
        let form = $('#form-attribute-semester');
        ...
        $.ajax({
            ...
            success: function(data){
                let dt = data.semester;
                hideLoad();
                scrollUp('#form-attribute-semester');
    ...
    $("#reset").click(function() {
      resetForm("#form-attribute-semester");
    })
    // reset
</script>