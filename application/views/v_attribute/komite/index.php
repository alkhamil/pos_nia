        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <form action="<?= $simpan ?>" method="POST" id="form-attribute-komite">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name" class="label-required">Nama Bulan</label>
...
<script>
    showLoad();
    let opt_attribute_type = new Option('KOMITE', '1', true, true);
    ...
    $("#reset").click(function() {
      resetForm("#form-attribute-komite");
    })
    // reset
</script>